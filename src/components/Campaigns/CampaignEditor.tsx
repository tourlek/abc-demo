      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {dateObj ? dateObj.toLocaleDateString() : <span>Select Date</span>}
          </Button>
        </PopoverTrigger>
                    ...
                    <div className="md:col-span-4">
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button
                            variant="outline"
                            className={`w-full justify-start text-left font-normal bg-card h-10 ${
                              !period.date && "text-muted-foreground"
                            }`}
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
